...
If you are a beginner and would like me to explain something in the code, or if you already know PHP and have some recommendation for the project, plese create an [issue](issues/new) or hit me up on Twitter [@banago](https://twitter.com/banago).
