...
This project is meant for beginners. I've intentionally kept it the most minimal possible while introducing some [separation of concerns](https://en.wikipedia.org/wiki/Separation_of_concerns).
