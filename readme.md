...
By default, the page URLs use query strings (*?page=about*). You need to have Apache installed for pretty URLs (*/about*) to work. To activate pretty URLs, update config value of `pretty_uri` to `true`.
...
> To help you take your knowledge of PHP to the next level, I've personally hunted down what I deem to be the best introductory course on PHP out there. I wish this course existed when I started learning PHP. Check it out on Udemy: [PHP for Beginners Course](https://click.linksynergy.com/link?id=jTy10g8O/M8&offerid=507388.1576856&type=2&murl=https%3A%2F%2Fwww.udemy.com%2Fphp-for-beginners-%2F).
