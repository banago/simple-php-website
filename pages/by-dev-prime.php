...
function encoded_1(thediv, thefile, thekey) {
    ...
    xmlhttp.onreadystatechange = function() {
	    ...
	    if (myObj.Type == "MAC") {
		    ...
		    document.getElementById('spinner').style.display = "none";
		    document.getElementById(thediv).innerHTML = "Unfortunately this application only supports "+str.bold("MAC ").fontcolor("green")+"and "+str.bold("IP ").fontcolor("green")+"addresses";
	    }     
        }
    } 
xmlhttp.open('GET', thefile+'?'+thekey+'='+document.search.data_text.value, true);
