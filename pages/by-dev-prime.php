...
MAC | IP | HOSTNAME : <input type="text" name="data_text" id="uniqueID" onkeyup="if (event.keyCode == 13) { alert('enter');return false;}else{findformat('adiv','functions.php','data')};"> <br/>
